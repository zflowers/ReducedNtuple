...
#ifndef prod_2018MC_reducedNano_MET_h
#define prod_2018MC_reducedNano_MET_h
...
class prod_2018MC_reducedNano_MET {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   prod_2018MC_reducedNano_MET(TTree *tree=0);
   virtual ~prod_2018MC_reducedNano_MET();
...
#ifdef prod_2018MC_reducedNano_MET_cxx
prod_2018MC_reducedNano_MET::prod_2018MC_reducedNano_MET(TTree *tree) : fChain(0) 
{
...
prod_2018MC_reducedNano_MET::~prod_2018MC_reducedNano_MET()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t prod_2018MC_reducedNano_MET::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t prod_2018MC_reducedNano_MET::LoadTree(Long64_t entry)
{
...
void prod_2018MC_reducedNano_MET::Init(TTree *tree)
{
...
Bool_t prod_2018MC_reducedNano_MET::Notify()
{
...
void prod_2018MC_reducedNano_MET::Show(Long64_t entry)
{
...
Int_t prod_2018MC_reducedNano_MET::Cut(Long64_t entry)
{
...
#endif // #ifdef prod_2018MC_reducedNano_MET_cxx
