...
// Tue Oct 15 12:28:12 2019 by ROOT version 6.10/09
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //UInt_t          nGenPart;
   //Float_t         GenPart_eta[92];   //[nGenPart]
   //Float_t         GenPart_mass[92];   //[nGenPart]
   //Float_t         GenPart_phi[92];   //[nGenPart]
   //Float_t         GenPart_pt[92];   //[nGenPart]
   //Int_t           GenPart_genPartIdxMother[92];   //[nGenPart]
   //Int_t           GenPart_pdgId[92];   //[nGenPart]
   //Int_t           GenPart_status[92];   //[nGenPart]
   //Int_t           GenPart_statusFlags[92];   //[nGenPart]
   ...
   //Float_t         Photon_mvaIDV1[5];   //[nPhoton]
   ...
   //Int_t           Photon_cutBasedBitmap[5];   //[nPhoton]
   //Int_t           Photon_cutBasedV1Bitmap[5];   //[nPhoton]
   ...
   //Float_t         ResolvedTopCandidate_discriminator[14];   //[nResolvedTopCandidate]
   //Float_t         ResolvedTopCandidate_eta[14];   //[nResolvedTopCandidate]
   //Float_t         ResolvedTopCandidate_mass[14];   //[nResolvedTopCandidate]
   //Float_t         ResolvedTopCandidate_phi[14];   //[nResolvedTopCandidate]
   //Float_t         ResolvedTopCandidate_pt[14];   //[nResolvedTopCandidate]
   //Int_t           ResolvedTopCandidate_j1Idx[14];   //[nResolvedTopCandidate]
   //Int_t           ResolvedTopCandidate_j2Idx[14];   //[nResolvedTopCandidate]
   //Int_t           ResolvedTopCandidate_j3Idx[14];   //[nResolvedTopCandidate]
   //Int_t           ResolvedTopCandidate_type[14];   //[nResolvedTopCandidate]
   ...
   //Int_t           GenJet_partonFlavour[17];   //[nGenJet]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/t3-ku/z374f439/../janguian/nanoAODTestDump/prod2017MC_NANO_1025.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/t3-ku/z374f439/../janguian/nanoAODTestDump/prod2017MC_NANO_1025.root");
      }
...
void prod2017MC_reducedNANO_MET::SetOutput(string outFile)
{
   m_outFile = outFile;
}
