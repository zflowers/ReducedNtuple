...
// Tue Oct 15 12:27:48 2019 by ROOT version 6.10/09
// from TTree Events/Events
// found on file: /home/t3-ku/z374f439/../janguian/nanoAODTestDump/prod2016MC_NANO_1.root
//////////////////////////////////////////////////////////

#ifndef prod2016MC_reducedNANO_MET_h
#define prod2016MC_reducedNANO_MET_h
...
class prod2016MC_reducedNANO_MET {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //Float_t         PFcand_chiso0p3[27];   //[nPFcand]
   //Float_t         PFcand_chiso0p4[27];   //[nPFcand]
   //Float_t         PFcand_totiso0p1[27];   //[nPFcand]
   //Float_t         PFcand_totiso0p2[27];   //[nPFcand]
   //Float_t         PFcand_totiso0p3[27];   //[nPFcand]
   //Float_t         PFcand_totiso0p4[27];   //[nPFcand]
   //Float_t         PFcand_trackiso[27];   //[nPFcand]
   //Float_t         PFcand_nearphopt[27];   //[nPFcand]
   //Float_t         PFcand_nearphoeta[27];   //[nPFcand]
   //Float_t         PFcand_nearphophi[27];   //[nPFcand]
   //Float_t         PFcand_nearestTrkDR[27];   //[nPFcand]
   //Int_t           PFcand_contJetIndex[27];   //[nPFcand]
   ...
   //Int_t           Electron_cutBased_Spring15[6];   //[nElectron]
   //Int_t           Electron_cutBased_Sum16[6];   //[nElectron]
   ...
   //Int_t           Electron_vidNestedWPBitmapSpring15[6];   //[nElectron]
   //Int_t           Electron_vidNestedWPBitmapSum16[6];   //[nElectron]
   ...
   //UInt_t          nGenPart;
   //Float_t         GenPart_eta[119];   //[nGenPart]
   //Float_t         GenPart_mass[119];   //[nGenPart]
   //Float_t         GenPart_phi[119];   //[nGenPart]
   //Float_t         GenPart_pt[119];   //[nGenPart]
   //Int_t           GenPart_genPartIdxMother[119];   //[nGenPart]
   //Int_t           GenPart_pdgId[119];   //[nGenPart]
   //Int_t           GenPart_status[119];   //[nGenPart]
   //Int_t           GenPart_statusFlags[119];   //[nGenPart]
   ...
   //Float_t         Jet_btagCSVV2[20];   //[nJet]
   //Float_t         Jet_btagDeepB[20];   //[nJet]
   //Float_t         Jet_btagDeepC[20];   //[nJet]
   //Float_t         Jet_btagDeepFlavB[20];   //[nJet]
   //Float_t         Jet_chEmEF[20];   //[nJet]
   //Float_t         Jet_chHEF[20];   //[nJet]
   //Float_t         Jet_chHadMult[20];   //[nJet]
   //Float_t         Jet_deepCSVb[20];   //[nJet]
   //Float_t         Jet_deepCSVbb[20];   //[nJet]
   //Float_t         Jet_deepCSVc[20];   //[nJet]
   //Float_t         Jet_deepCSVudsg[20];   //[nJet]
   //Float_t         Jet_deepFlavourb[20];   //[nJet]
   //Float_t         Jet_deepFlavourbb[20];   //[nJet]
   //Float_t         Jet_deepFlavourc[20];   //[nJet]
   //Float_t         Jet_deepFlavourg[20];   //[nJet]
   //Float_t         Jet_deepFlavourlepb[20];   //[nJet]
   ...
   //Float_t         Jet_qgptD[20];   //[nJet]
   //Float_t         Jet_rawFactor[20];   //[nJet]
   //Float_t         Jet_bRegCorr[20];   //[nJet]
   ...
   //Int_t           Jet_nElectrons[20];   //[nJet]
   //Int_t           Jet_nMuons[20];   //[nJet]
   //Int_t           Jet_puId[20];   //[nJet]
   //Int_t           Jet_qgMult[20];   //[nJet]
   //Float_t         LHE_HT;
   ...
   //Float_t         Photon_mvaID17[8];   //[nPhoton]
   ...
   //Int_t           Photon_cutBased17Bitmap[8];   //[nPhoton]
   ...
   //Bool_t          Photon_mvaID17_WP80[8];   //[nPhoton]
   //Bool_t          Photon_mvaID17_WP90[8];   //[nPhoton]
   ...
   //Float_t         ResolvedTopCandidate_discriminator[22];   //[nResolvedTopCandidate]
   //Float_t         ResolvedTopCandidate_eta[22];   //[nResolvedTopCandidate]
   //Float_t         ResolvedTopCandidate_mass[22];   //[nResolvedTopCandidate]
   //Float_t         ResolvedTopCandidate_phi[22];   //[nResolvedTopCandidate]
   //Float_t         ResolvedTopCandidate_pt[22];   //[nResolvedTopCandidate]
   //Int_t           ResolvedTopCandidate_j1Idx[22];   //[nResolvedTopCandidate]
   //Int_t           ResolvedTopCandidate_j2Idx[22];   //[nResolvedTopCandidate]
   //Int_t           ResolvedTopCandidate_j3Idx[22];   //[nResolvedTopCandidate]
   //Int_t           ResolvedTopCandidate_type[22];   //[nResolvedTopCandidate]
   ...
   //UInt_t          nSB;
   //Float_t         SB_dlen[4];   //[nSB]
   //Float_t         SB_dlenSig[4];   //[nSB]
   //Float_t         SB_DdotP[4];   //[nSB]
   //Float_t         SB_dxy[4];   //[nSB]
   //Float_t         SB_dxySig[4];   //[nSB]
   //Int_t           SB_JetIdx[4];   //[nSB]
   //UInt_t          nSubJet;
   ...
   //Float_t         PFcand_dz[27];   //[nPFcand]
   //Float_t         PFcand_eta[27];   //[nPFcand]
   //Float_t         PFcand_fromPV[27];   //[nPFcand]
   //Float_t         PFcand_mass[27];   //[nPFcand]
   //Float_t         PFcand_phi[27];   //[nPFcand]
   //Float_t         PFcand_pt[27];   //[nPFcand]
   ...
   //UChar_t         Jet_cleanmask[20];   //[nJet]
   //UChar_t         Muon_cleanmask[7];   //[nMuon]
   //UChar_t         Photon_cleanmask[8];   //[nPhoton]
   //UChar_t         Tau_cleanmask[6];   //[nTau]
   //Float_t         SB_chi2[4];   //[nSB]
   //Float_t         SB_eta[4];   //[nSB]
   //Float_t         SB_mass[4];   //[nSB]
   //Float_t         SB_ndof[4];   //[nSB]
   //Float_t         SB_phi[4];   //[nSB]
   //Float_t         SB_pt[4];   //[nSB]
   //Int_t           SB_ntracks[4];   //[nSB]
   ...
   prod2016MC_reducedNANO_MET(TTree *tree=0);
   virtual void     SetOutput(string outFile);
   virtual ~prod2016MC_reducedNANO_MET();
...
#ifdef prod2016MC_reducedNANO_MET_cxx
prod2016MC_reducedNANO_MET::prod2016MC_reducedNANO_MET(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   /*if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/t3-ku/z374f439/../janguian/nanoAODTestDump/prod2016MC_NANO_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/t3-ku/z374f439/../janguian/nanoAODTestDump/prod2016MC_NANO_1.root");
      }
...
prod2016MC_reducedNANO_MET::~prod2016MC_reducedNANO_MET()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

void prod2016MC_reducedNANO_MET::SetOutput(string outFile)
{
   m_outFile = outFile;
}

Int_t prod2016MC_reducedNANO_MET::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t prod2016MC_reducedNANO_MET::LoadTree(Long64_t entry)
{
...
void prod2016MC_reducedNANO_MET::Init(TTree *tree)
{
...
Bool_t prod2016MC_reducedNANO_MET::Notify()
{
...
void prod2016MC_reducedNANO_MET::Show(Long64_t entry)
{
...
Int_t prod2016MC_reducedNANO_MET::Cut(Long64_t entry)
{
...
#endif // #ifdef prod2016MC_reducedNANO_MET_cxx
