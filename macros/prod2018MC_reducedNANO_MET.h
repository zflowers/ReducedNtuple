...
// Tue Oct 15 12:28:30 2019 by ROOT version 6.10/09
// from TTree Events/Events
// found on file: /home/t3-ku/z374f439/../janguian/nanoAODTestDump/prod2018MC_NANO_1-1.root
//////////////////////////////////////////////////////////

#ifndef prod2018MC_reducedNANO_MET_h
#define prod2018MC_reducedNANO_MET_h
...
class prod2018MC_reducedNANO_MET {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   prod2018MC_reducedNANO_MET(TTree *tree=0);
   virtual ~prod2018MC_reducedNANO_MET();
...
#ifdef prod2018MC_reducedNANO_MET_cxx
prod2018MC_reducedNANO_MET::prod2018MC_reducedNANO_MET(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/t3-ku/z374f439/../janguian/nanoAODTestDump/prod2018MC_NANO_1-1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/t3-ku/z374f439/../janguian/nanoAODTestDump/prod2018MC_NANO_1-1.root");
      }
...
prod2018MC_reducedNANO_MET::~prod2018MC_reducedNANO_MET()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

void prod2018MC_reducedNANO_MET::SetOutput(string outFile)
{
   m_outFile = outFile;
}

Int_t prod2018MC_reducedNANO_MET::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t prod2018MC_reducedNANO_MET::LoadTree(Long64_t entry)
{
...
void prod2018MC_reducedNANO_MET::Init(TTree *tree)
{
...
Bool_t prod2018MC_reducedNANO_MET::Notify()
{
...
void prod2018MC_reducedNANO_MET::Show(Long64_t entry)
{
...
Int_t prod2018MC_reducedNANO_MET::Cut(Long64_t entry)
{
...
#endif // #ifdef prod2018MC_reducedNANO_MET_cxx
